...
public class ResCloudlet {
	 ...
	 * @post $result >= 0
	 */
	public long getRemainingCloudletLengthInstruction() {
	...
	public long getRemainingCloudletLength() {
		...
		return (long) Math.ceil(1.0*length / Consts.MILLION);		
	}

	public double getActualRemainingCloudletLength() {
		long length = cloudlet.getCloudletTotalLength() * Consts.MILLION - cloudletFinishedSoFar;
		...
		return (1.0*length / Consts.MILLION);		
	}
	/**
