...
public class DatacenterCharacteristics {
	 ...
	 *            range [GMT-12 ... GMT+13]
	 * @param costPerVm the cost per vm to use this resource           
	...
	/**
	 * Gets the cost per vm with a resource.
	 * 
	 * @return the cost using a resource
	 */
	...
	/**
	 * Sets the cost per vm.
	 * 
	 * @param costPerVm the new cost per vm
	 */
	protected void setCostPerVm(double costPerVm) {
