...
import org.cloudbus.cloudsim.information.CloudletTimingInformation;
...
public class Cloudlet {
	...
	/** The  result of reCAPTCHA test */
	private boolean Pass_reCAPTCHA;
	
	/** The  requset type */
	private int requestType;
	
	// load balancer information
	CloudletTimingInformation loadbalancerTimingInfo;
	
	// mitigation information
	CloudletTimingInformation mitigationTimingInfo;
	
	// web servers information
	CloudletTimingInformation webserversTimingInfo;
	 ...
	 * @param SP the sender source port
	 * @param Pass_reCAPTCHA the result of reCAPTCHA test
	 * @param requestType the type of the request TCP session connection (0) or web page request (1)
	 * @param cloudletId the unique ID of this Cloudlet
	 * @param cloudletLength the length or size (in MI) of this cloudlet to be executed in a
	 *            PowerDatacenter
	 * @param cloudletFileSize the file size (in byte) of this cloudlet <tt>BEFORE</tt> submitting
	...
	public Cloudlet(
		...
		this.IP = IP;
		this.SP = SP;
		this.Pass_reCAPTCHA = Pass_reCAPTCHA;
		this.requestType = requestType;
		vmId = -1;
		accumulatedBwCost = 0.0;
		costPerBw = 0.0;

		loadbalancerTimingInfo = new CloudletTimingInformation();
		mitigationTimingInfo = new CloudletTimingInformation();
		webserversTimingInfo = new CloudletTimingInformation();
		requiredFiles = new LinkedList<String>();
	}
	 ...
	 * <tt>Processing Cost = processing cost </tt> .
	 * 
	...
	public double getProcessingCost() {
		...
		double cost = 0;
		// ... CPU cost
		cost += getCostPerSec()*getActualCPUTime();
		return cost;
	}

	/**
	 * Gets the total cost of processing or executing or file transfering this Cloudlet
	 * <tt>Processing Cost = input data transfer + processing cost + output transfer cost</tt> .
	 * 
	 * @return the total cost of Cloudlet
	 * @pre $none
	 * @post $result >= 0.0
	 */
	public double getCloudletCost() {
		...
		cost += costPerBw * getCloudletFileSize();
		// ...plus output cost
	...
	/**
	 * Gets the sender source port.
	 * 
	 * @return the sender source port
	 * @pre $none
	 * @post $none
	 */
	public int getSP() {
	...
	/**
	 * Gets the result of reCAPTCHA test.
	 * 
	 * @return the result of reCAPTCHA test
	 * @pre $none
	 * @post $none
	 */
	public boolean getPass_reCAPTCHA() {
		return Pass_reCAPTCHA;
	}
	...
	/**
	 * Gets the load balancer timing information.
	 * 
	 * @return the load balancer timing informatio
	 * @pre $none
	 * @post $none
	 */
	public CloudletTimingInformation getLoadbalancerTimingInfo() {
		return loadbalancerTimingInfo;
	}
	
	/**
	 * Gets the mitigation timing information.
	 * 
	 * @return the mitigation timing informatio
	 * @pre $none
	 * @post $none
	 */
	public CloudletTimingInformation getMitigationTimingInfo() {
		return mitigationTimingInfo;
	}
	
	/**
	 * Gets the web servers timing information.
	 * 
	 * @return the web servers timing informatio
	 * @pre $none
	 * @post $none
	 */
	public CloudletTimingInformation getWebServersTimingInfo() {
		return webserversTimingInfo;
	}
}
